...
const initScene = async () => {
    ...
    camera = markRaw(new THREE.PerspectiveCamera(75, 1, 0.01, 10));
    camera.position.z = 0;
    camera.position.x = 0;
    camera.position.y = 1;
    ...
    new_ufo_board1 = markRaw(ufo_board1.scene.clone());
...
<template>
    <div class="list-item">
        ...
        <div class="description">UFO_Board</div>
    </div>
</template>
